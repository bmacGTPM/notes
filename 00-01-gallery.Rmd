...
For easy browsing and navigating, we start with a gallery of tables and visualizations that we will make, along with hyperlinks to where each table or visualization is located in this book.
